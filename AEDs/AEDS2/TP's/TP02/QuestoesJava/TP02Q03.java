...
public class TP02Q03 {
    ...
    public static boolean pesquisaSequencial(Pokemon[] poke, String name) {
        // Pesquisa sequencial usando o name como busca
        int tamanho = poke.length;
        String tmpName;
        
        for (int i = 0; i < tamanho; i++) {
            if (poke[i] != null) {
                tmpName = poke[i].getName();
    ...
    public static void main(String[] args) {
        ...
        while (sc.hasNext()) {
            ...
            boolean resp = pesquisaSequencial(poke, entrada);
            if (resp) {
